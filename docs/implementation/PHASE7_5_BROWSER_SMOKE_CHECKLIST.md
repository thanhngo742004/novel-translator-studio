...
- Real Edge browser smoke via DevTools: visible Phase 7.5 labels, LTP off as unavailable, provider test success with redacted API key, and `Browser Smoke` translation job completed `Production rollout PASS` at `100%`.
